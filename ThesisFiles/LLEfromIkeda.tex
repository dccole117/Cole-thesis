...
\begin{equation}
\frac{\partial \psi}{\partial s}= -\frac{\pi(1-\eta)}{\mathcal{F}} \psi+i\frac{\pi}{\mathcal{F}}|\psi|^2 \psi -i \frac{\pi}{\mathcal{F}} \frac{\beta_2}{2} \frac{\partial^2 \psi}{\partial \theta^2},
\end{equation}
